...
export function Navigation() {
  return (
    <>
      ...
      <div className="row-start-3 mb-safe-bottom mt-[2px] h-[--nav-height] w-full shrink-0 sm:row-start-2 sm:ml-safe-left sm:mr-[2px] sm:h-px sm:w-[--nav-width-sm] lg:w-[--nav-width-lg]" />
    </>
  );
}
